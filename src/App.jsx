      ...
      <main>
        <section id='home' className='w-[100vw] h-auto lg:h-[100vh] relative flex justify-center items-center'>
          ...
          <div className='absolute h-[100%] w-[100%] text-center flex justify-center items-center text-transparent  top-0 left-0  -z-10 '>
            <h3 className='text-stroke-1 opacity-50 uppercase font-bold text-[13vw] md:text-[20vw] lg:text-[150px] text-gradient-stroke'>Artist&nbsp;&nbsp;&nbsp;Yuvraj</h3>
          </div>
        ...
        <section id='portfolio'>
          ...
          <h3 className='text-center mx-auto text-[5rem]  lg:text-[128px] font-bold drop-shadow-md uppercase'>featured Work</h3>
