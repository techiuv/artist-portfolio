      ...
      <main>
        <section id='home' className='w-[100%]  h-auto lg:h-[100vh] relative flex justify-center items-center'>
          ...
          <div className='absolute h-[100%] w-[100%] text-center flex justify-between lg:justify-center lg:gap-20 items-center text-transparent  top-0 left-0  -z-10 '>
            <h3 className='text-stroke-1 opacity-50 uppercase font-bold text-[11vw] md:text-[12vww]  lg:text-[150px] text-gradient-stroke mb-28'>Artist</h3>
            <h3 className='text-stroke-1 opacity-50 uppercase font-bold text-[11vw] md:text-[12vww]  lg:text-[150px] text-gradient-stroke mb-28'> Yuvraj</h3>
          </div>
