  ...
  useGSAP(() => {
    ...
    if (isLoading) {
      tl.fromTo(
        '.loader',
        { opacity: 1, scale: 1 },
        { opacity: 0, scale: 0.8, duration: 1.5, ease: 'power2.out', onComplete: () => setIsLoading(false) }
      );
    }
    ...
    <>
      ...
      <main>
        <section id="home" className="w-[100%] mt-[5vh] md:mt-[10vh] h-auto lg:h-[100vh] relative flex justify-center items-center">
          ...
          <div className="absolute h-[100%] w-[95%] mx-auto text-center flex justify-between lg:gap-20 items-center text-transparent top-0 left-1/2 -translate-x-1/2 -z-10">
            <h3 className="text-stroke-1 opacity-50 uppercase font-extrabold md:font-bold text-[10vw] md:text-[11vw] lg:text-[11.5vw] text-gradient-stroke mb-28 hero-txt">
              Artist
            </h3>
            <h3 className="text-stroke-1 opacity-50 uppercase font-extrabold md:font-bold text-[10vw] md:text-[10vw] lg:text-[11.5vw] text-gradient-stroke mb-28 hero-txt">
              Yuvraj
            </h3>
          </div>
        </section>
        ...
        <section id="portfolio" className="w-[100%]">
          ...
          <div className="w-[90%] md:w-3/4 mx-auto">
            ...
            <Cards
              ...
              description={
                'This artwork depicts a realistic hand sculpted in charcoal, seemingly deteriorating as the top part of the fingers disintegrates into small, textured fragments. The concept highlights the inevitable truth that every birth leads to a deadline, capturing the fragile balance between existence and oblivion.'
              }
              year={2024}
              medium={'charcoal'}
            ...
            <Cards
              tittle={'Growth'}
              description={
                "This artwork shows a tree growing from a tightly clenched stack of rugged, textured hands, symbolizing life's obstacles such as struggles and resistance. Despite these challenges, the tree emerges with resilience, its roots piercing through the fingers, representing the unstoppable spirit of growth."
              }
              year={2024}
              medium={'charcoal'}
