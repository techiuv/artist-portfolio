      ...
      <main>
        <section id='home' className='w-[100%] mt-[5vh] md:mt-[10vh] h-auto lg:h-[100vh] relative flex justify-center items-center'>
          ...
          <div className='absolute h-[100%] w-[95%] bg-red-50 mx-auto text-center flex justify-center lg:gap-20 items-center text-transparent top-0 left-1/2 -translate-x-1/2 -z-10'>
            <h3 className='text-stroke-1 opacity-50 uppercase font-extrabold md:font-bold text-[11vw] md:text-[12vww] lg:text-[11vw] text-gradient-stroke mb-28 tracking-widest hero-txt'>Artist</h3>
            <h3 className='text-stroke-1 opacity-50 uppercase font-extrabold md:font-bold text-[11vw] md:text-[12vww] lg:text-[11vw] text-gradient-stroke mb-28 tracking-widest hero-txt'>Yuvraj</h3>
          </div>
        </section>
